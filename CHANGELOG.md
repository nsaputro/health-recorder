...
### Changed
- `CLAUDE.md` — added Versioning section requiring `mcp__github__get_latest_release` to be
  called before setting any version number in a PR, to avoid reusing already-released versions.
