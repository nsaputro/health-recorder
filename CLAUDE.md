...
2. Move `## [Unreleased]` entries in `CHANGELOG.md` to a new `## [x.y.z] - YYYY-MM-DD` heading and update the comparison links at the bottom
3. Merge via PR to `main`
4. Go to Actions → Release → Run workflow → enter the new version number
